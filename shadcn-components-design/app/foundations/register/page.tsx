...
export default function RegisterFoundationPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      // 2. ASIGNAR ROL FOUNDATION (igual que en el otro registro)
      ...
      if (!roleRes.ok)
        throw new Error(roleData.error?.message || "Error asignando rol");
      ...
      if (!foundRes.ok)
        throw new Error(
          foundData.error?.message || "Error al crear la fundación",
        );

      // 5. Login usando AuthContext
      await login(jwt);
      ...
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-muted-foreground text-sm pt-3">
            Registra tu organización en la red
          </p>
        </div>
          ...
          <div className="flex items-center gap-3 pb-2 border-b border-border">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-xs">
                Crea tu acceso y los datos de tu organización
              </p>
            </div>
          </div>
